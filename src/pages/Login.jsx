  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg w-96">
        ...
        {error && (
          <p className="mb-4 text-red-600 dark:text-red-400 font-medium text-center">{error}</p>
        )}
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="relative">
            <input
              ...
              className="w-full border dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-purple-500"
              required
            />
            <span
      ...
      {forgotOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-80 relative">
            ...
            <h3 className="text-lg font-bold text-purple-700 dark:text-purple-300 mb-3">Reset Password</h3>
            <input
              type="email"
